...
This readme contains the official ProximaX instructions on how to use the community distribution for a Sirius Blockchain Peer.  The deployable Peer automatically links to ProximaX MAINNET, provided you setup the validator key (harvestKey).
